...
* icon:slideshare[] link:* icon:youtube[] link:http://dduportal.github.io/presentations/devfest-lille-2017/[Slides,window="_blank"]

#### Devoxx France (Paris) 2017

* image:fr.png[width=15] 
